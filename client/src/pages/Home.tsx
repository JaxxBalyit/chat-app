import { Channel, ChannelHeader, ChannelList, ChannelListMessengerProps, Chat, 
        LoadingIndicator, MessageInput, MessageList, Window, useChatContext } from "stream-chat-react"
        ...
        <div className="w-60 flex flex-col gap-4 m-3 h-full">
            ...
            { loadedChannels != null && loadedChannels.length > 0 
                ? loadedChannels.map(channel => {
                    ...
                    return (
                        <button 
                            onClick={() => setActiveChannel(channel)} disabled={isActive} 
            ...
            <Button onClick={() => logout.mutate()} disabled={logout.isLoading}>Log Out</Button>
        </div>
    )
}